<script lang="ts">
	...
	// DISABLED: Prompt suggestions functionality has been disabled
	...
	const init = async () => {
		...
		promptSuggestions = []; // Always keep empty
	...
	>
		<div class="  overflow-y-scroll scrollbar-hidden h-full pr-1.5">
			...
			<div class="mb-3.5">
				...
				{#if $user?.role === 'admin'}
					<!-- DISABLED: Prompt suggestions UI has been disabled -->
					<div class=" space-y-3" style="display: none;">
						<!-- All prompt suggestions UI is hidden -->
