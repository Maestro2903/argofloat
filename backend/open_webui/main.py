...
app.state.config.ENABLE_NVIDIA_API = ENABLE_NVIDIA_API
app.state.config.NVIDIA_BASE_URLS = NVIDIA_API_BASE_URLS
app.state.config.NVIDIA_API_KEYS = NVIDIA_API_KEYS
app.state.config.NVIDIA_API_CONFIGS = NVIDIA_API_CONFIGS

app.state.NVIDIA_MODELS = {}
...
app.include_router(floatchat_agent.router, prefix="/api/v1", tags=["floatchat"])
